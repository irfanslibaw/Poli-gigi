                        ...
                        <div class="my-1 px-1 w-full">
                            <div class="overflow-hidden rounded-lg shadow-md p-3 bg-slate-200 tracking-wide space-y-2">
                                ...
                                <form action="{{ url('ruang/' .$ruang->id) }}" method="post">
                                    ...
                                    @method('PUT')
                                    <div class="space-y-2">
                                        <label for="nama_ruang" class="ml-3 font-medium">Nama Ruangan</label>
                                        <input type="text" name="nama_ruang" id="nama_ruang" required value="{{ $ruang->nama_ruang }}"
                                    ...
                                    <div class="flex justify-between"><a href="{{ url('ruang') }}">
