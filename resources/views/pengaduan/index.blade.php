                    ...
                    <div class="container px-5 py-5 mx-auto">
                        <div class="my-1 px-1 w-full">
                            <div class="overflow-hidden rounded-lg shadow-md p-3 bg-slate-200 tracking-wide space-y-2">
                                <div class="justify-between p-4"><a href="{{ url('pengaduan/create') }}" >
                                    <button type="button"
                                        class="float-right bg-slate-700 text-white p-2 rounded-md">Tambah
                                    </button></a>
                                    <form action="{{ url('pengaduan') }}" method="get" class="hidden sm:flex">
                                    ...
                                    <table class="w-full text-sm text-left text-gray-600">
                                        <thead
                                            ...
                                            <tr>
                                                ...
                                                <th class="border-collapse border p-2">Pengaduan</th>
                                        ...
                                        <tbody class="bg-gray-300 rounded-md">
                                            ...
                                            <tr>
                                                ...
                                                <td class="p-2">
                                                    <a href="{{ url('pengaduan/'.$p->id.'/edit') }}"
