                    ...
                    <div class="container px-5 py-5 mx-auto">
                        <div class="my-1 px-1 w-full">
                            <div class="overflow-hidden rounded-lg shadow-md p-10 bg-slate-200 tracking-wide space-y-2">
                                <h1 class="flex justify-center text-2xl font-semibold">DATA PENGADUAN</h1>
                                <h2 class="flex justify-center text-md">Mohon Mengubah Data Dengan Hati-hati</h2>
                                <br>
                                <form action="{{ url('pengaduan/' .$pengaduan->id) }}" method="post">
                                    @csrf
                                    @method('PUT')
                                    <div class="space-y-2">
                                        ...
                                        class="block w-full p-3 mt-2 rounded-xl text-gray-900 bg-stone-50 appearance-none focus:outline-gray-800 focus:bg-gray-100 focus:shadow-inner">
                                            ...
                                            <option value="{{ $pengaduan->pasien_id }}"></option>
                                            <br>
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <input type="text" name="pengaduan" id="pengaduan" required value="{{ $pengaduan->pengaduan }}"
                                    ...
                                    <div class="flex justify-between"><a href="{{ url('pengaduan') }}">
                                        <button type="button"
