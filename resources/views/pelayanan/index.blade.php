                    ...
                    <div class="container px-5 py-5 mx-auto">
                        <div class="my-1 px-1 w-full">
                            <div class="overflow-hidden rounded-lg shadow-md p-3 bg-slate-200 tracking-wide space-y-2">
                                <div class="justify-between p-4"><a href="{{ url('pelayanan/create') }}">
                                    <button href="" type="button"
                                        class="float-right bg-slate-700 text-white p-2 rounded-md">Tambah
                                    </button></a>
                                    <form action="{{ url('pelayanan') }}" method="get" class="hidden sm:flex">
                                ...
                                <div class="overflow-x-auto">
                                            ...
                                            <tr>
                                                ...
                                                <td class="p-2">
                                                    <form onsubmit="return confirm('Yakin Ingin Menghapus Data Ini?')"
                                                        action="{{ url('pelayanan/'.$p->id) }}" method="post">
                                                        @csrf
                                                        @method('DELETE')
                                                ...
                                                <td class="p-2">
                                                    <a href="{{ url('pelayanan/'.$p->id.'/edit') }}"
                                    ...
                                    {{ $pelayanan->links('pagination::tailwind') }}
                                </div>
                            </div>
                        </div>
                    </div>
