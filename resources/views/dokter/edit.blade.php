                                           ...
                                           <div class="overflow-hidden rounded-lg shadow-md p-3 bg-slate-200 tracking-wide space-y-2">
                                               ...
                                               <form action="{{ url('dokter/' .$dokter->id) }}" method="post">
                                                   ...
                                                   <div class="space-y-2">
                                                       ...
                                                       <input type="number" name="nik" id="nik" required value="{{ $dokter->nik }}"
                                                   ...
                                                   <div class="space-y-2">
                                                       ...
                                                       <input type="text" name="nama" id="nama" required value="{{ $dokter->nama }}"
                                                           class="block w-full p-2 mt-2 rounded-xl text-gray-900 bg-stone-50 appearance-none focus:outline-gray-800 focus:bg-gray-100 focus:shadow-inner">
                                                   </div>
                                                   <br>
                                                   ...
                                                   <div class="space-y-2">
                                                       ...
                                                       <input type="email" name="email" id="email" required value="{{ $dokter->email }}"
                                                           class="block w-full p-2 mt-2 rounded-xl text-gray-900 bg-stone-50 appearance-none focus:outline-gray-800 focus:bg-gray-100 focus:shadow-inner">
                                                   </div>
                                                   <br>
                                                   ...
                                                   <div class="space-y-2">
                                                       ...
                                                       <input type="number" name="no_hp" id="no_hp" required value="{{ $dokter->no_hp }}"
                                                           class="block w-full p-2 mt-2 rounded-xl text-gray-900 bg-stone-50 appearance-none focus:outline-gray-800 focus:bg-gray-100 focus:shadow-inner">
                                                   </div>
                                                   <br>
                                                   ...
                                                   <div class="space-y-2">
                                                       ...
                                                       <input type="text" name="password" id="password" required value="{{ $dokter->password }}"
                                                           class="block w-full p-2 mt-2 rounded-xl text-gray-900 bg-stone-50 appearance-none focus:outline-gray-800 focus:bg-gray-100 focus:shadow-inner">
                                                   </div>
                                                   <br>

                                                   <div class="flex justify-between"><a href="{{ url('dokter') }}">
