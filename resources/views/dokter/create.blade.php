                        ...
                        <div class="my-1 px-1 w-full">
                            <div class="overflow-hidden rounded-lg shadow-md p-3 bg-slate-200 tracking-wide space-y-2">
                                ...
                                <form action="{{ url('dokter') }}" method="post">
                                    @csrf
                                    <div class="space-y-2">
                                        <label for="nik" class="ml-3 font-medium @error('title') is-invalid @enderror">NIK</label>
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <input type="email" name="email" id="email" required value="{{ Session::get
                                            ('email') }}"
                                            class="block w-full p-2 mt-2 rounded-xl text-gray-900 bg-stone-50 appearance-none focus:outline-gray-800 focus:bg-gray-100 focus:shadow-inner @error('email') is-invalid @enderror">
                                            @error('email')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
