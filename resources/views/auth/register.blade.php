...
<div class="grid min-h-screen place-items-center">
    <div class="w-9/12 p-12 bg-white sm:w-8/12 md:w-1/2 lg:w-5/12 rounded-xl">
        ...
        <!-- Name -->
        <div>
            <label for="name" :value="__('Name')" class="block mt-2 text-xs font-semibold text-gray-600 uppercase">Nama</label>
            <input id="name" class="block w-full p-3 mt-2 rounded-xl text-gray-900 bg-stone-50 appearance-none focus:outline-2 focus:bg-gray-100 focus:shadow-inner" type="text" name="name" placeholder="contoh: Irfan Aja" :value="old('Name')" required autofocus />
