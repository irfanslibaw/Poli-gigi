...
<div class="grid min-h-screen place-items-center">
    ...
    <form method="POST" action="{{ route('password.email') }}">
        ...
        <br>
            ...
            <p class="justify-between inline-block mt-4 text-sm text-gray-500">Kembali <a href="{{ url('login') }}" class="cursor-pointer hover:text-blue-800">Ke Halaman Sebelumnya</a></p><br>
          </div>
        </form>
    </div>
  </div>
